...
class AuthSignupVerifyAccountSuccess : BaseFragment() {

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.fragment_auth_verify_success, container, false)
    }
    ...
    companion object {
        ...
        fun newInstance(titleResId: Int?, descriptionResId: Int) =
                AuthSignupVerifyAccountSuccess().apply {
