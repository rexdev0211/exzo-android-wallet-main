...
import io.exzocoin.wallet.modules.settings.main.MainSettingsModule.IMainSettingsInteractor
import io.exzocoin.wallet.modules.settings.main.MainSettingsModule.IMainSettingsInteractorDelegate
import io.exzocoin.wallet.modules.settings.main.MainSettingsModule.IMainSettingsRouter
import io.exzocoin.wallet.modules.settings.main.MainSettingsModule.IMainSettingsView
import io.exzocoin.wallet.modules.settings.main.MainSettingsModule.IMainSettingsViewDelegate
...
class MainSettingsPresenter(
    ...
    override fun didTapFeaturedProject() {
        router.openFeaturedProject()
    }
