...
import io.exzocoin.wallet.modules.walletconnect.list.WalletConnectListModule
import io.exzocoin.core.getNavigationResult
import io.exzocoin.languageswitcher.LanguageSettingsFragment
...
class MainSettingsFragment : BaseFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val featuredProject = SettingsMenuItem(R.string.Settings_FeaturedProjectForm, R.drawable.ic_notification_icon, listPosition = ListPosition.Single) {
            presenter.didTapFeaturedProject()
        }
    ...
    private fun subscribeToRouterEvents(router: MainSettingsRouter) {
        ...
        router.openFeatuedProjectEvent.observe(viewLifecycleOwner, {
            findNavController().navigate(R.id.featuredProjectFragment, null, navOptions())
        })
    }
