...
class RateAppManager(
    ...
    companion object {
        ...
        fun getPlayMarketAppIntent(): Intent {
            val uri = Uri.parse("market://details?id=io.exzocoin.wallet")  //context.packageName
        ...
        fun getPlayMarketSiteIntent(): Intent {
            return Intent(Intent.ACTION_VIEW, Uri.parse("http://play.google.com/store/apps/details?id=io.exzocoin.bankwallet"))
        }
    }
